...
func getSRMValFrom(image img:UIImage) -> Double{
    ...
    print("white is returned because filter was not set or image could not be obtained from filter")
    return 0.0
}

func SRMValFrom(blueColor bVal:CGFloat) -> Double{
//    var absorbance = log(bVal/bVal)/log(10)
    //here D,(dilution) is set to 1 meaning sample is not diluted
//    var SRMVal = 12.7 * 1 * absorbance
